...
@app.blob_trigger(arg_name="myblob", path="arquivosb3",
...
# @app.blob_trigger(arg_name="client", path="arquivosb3",
#                   connection="8bcae4_STORAGE")
# def load_file_b3_trigger(client: blob.BlobClient):
#     logging.info(
